...
class _MyHomePage extends State<MyHomePage> {
  List<Client> clients = [
    Client(name: 'Jean', surname: 'Simon', phone: '924584301'),
    Client(name: 'Donald', surname: 'Trump', phone: '985214765'),
    Client(name: 'Vladimir', surname: 'Putin', phone: '931764258'),
    Client(name: 'Martin', surname: 'Vizcarra', phone: '951753654')
  ];
